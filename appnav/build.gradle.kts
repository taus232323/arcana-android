...
dependencies {
    ...
    testImplementation(platform(libs.network.retrofit.bom))
    testImplementation(libs.network.retrofit)
    testImplementation(libs.network.retrofit.converter.serialization)
